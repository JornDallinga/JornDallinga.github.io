...
# ----- next parameters ----#
# assign the unique available bands to a variable
bands <-  df_probav_sm[df_probav_sm$date == df_probav_sm$date[1], 'band']
# assign the acquisition dates to a variable
